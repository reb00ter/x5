...
from .serializers import FreeContainerRequestSerializer, FreeContainerResultsSerializer, \
    NeedContainerResultsSerializer, NeedContainerRequestSerializer
...
class NeedContainersRequestsViewSet(viewsets.ModelViewSet):
    detail_serializer_class = NeedContainerResultsSerializer
    serializer_class = NeedContainerRequestSerializer
    permission_classes = (IsAuthenticatedOrReadOnly,)
